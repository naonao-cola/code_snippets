...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", nargs="+", type=str, default="/data/hjx/B19/results/exp3/weights/best.pt", help="model.pt path(s)")
    ...
    parser.add_argument("--iou-thres", type=float, default=0.1, help="TF.js NMS: IoU threshold")
