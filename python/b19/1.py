...
# 图像路径
image_path = '/data/hjx/B19/data/BM/TEST/1'
output_path = '/data/hjx/B19/data/BM/TEST/OUT'
...
for img_file in img_files:
    ...
    if img is None:
        ...
        cut_img = dilation[label[1]-50:label[3]+50, label[0]-50:label[2]+50]
        ...
        contour_areas = []
        for contour in contours:
            contour = contour + [label[0]-50, label[1]-50]
