...
RKNN_MODEL = '../rknn_model/RBC.rknn'
device_id = '420035ef8cdff1f9'
#DATASET = './dataset.txt'
test_dir = "/media/y/GUTAI/windows/cell/datasets/volume/volume_from_li_20231120/images/ori/10"
save_dir = "./rdw"
    ...
    for filename in os.listdir(test_dir):
        ...
        for i in thr_thresholds:
            ...
            if boxes is not None:
                ...
                for box in boxes:
                    box = recover_box(box, img_ori.shape[:-1], resized_shape = 800)
                ...
                img_2 = cv2.cvtColor(img_ori, cv2.COLOR_BGR2RGB)
                draw(img_2, new_boxes, scores, classes)
                cv2.imwrite(img_save_path, img_2)
