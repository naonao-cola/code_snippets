...
"""
参考链接：
https://blog.csdn.net/WYKB_Mr_Q/article/details/132035597?spm=1001.2101.3001.6650.2&utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7ERate-2-132035597-blog-128220346.235%5Ev40%5Epc_relevant_anti_t3&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7ERate-2-132035597-blog-128220346.235%5Ev40%5Epc_relevant_anti_t3&utm_relevant_index=5
...
if __name__ == '__main__':
    ...
    parser.add_argument("--class_name", default="pin",
                        help="class name", type=str)
    parser.add_argument("--input",  default="../dataset/pin/Annotations",
                        help="json file path (labelme)", type=str)
    parser.add_argument("--output", default="../dataset/pin/coco",
                        help="output file path (coco format)", type=str)
    parser.add_argument("--join_num",  default=4,
                        help="number of join", type=int)
    ...
    l2c_json.save_coco_json(keypoints, os.path.join(
        saved_coco_path, "keypoints.json"))
