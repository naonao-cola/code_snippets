...
from pytorch_grad_cam import GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM, AblationCAM #,KPCA_CAM
...
def get_params():
    params = {
        'weight': '/home/greatek/huangsc/test001/run/konghu2/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        #'weight': '/home/greatek/huangsc/test001/run/person2/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/home/greatek/wangww/demo/py/test003/66e05ccc3f89422c9a0540097f4462ca.png', './result')
