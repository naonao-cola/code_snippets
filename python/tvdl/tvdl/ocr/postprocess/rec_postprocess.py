...
class BaseRecLabelDecode(object):
    ...
    def __init__(self,
        ...
        if character_type == "en":
            self.character_str = language_dict[character_type]
...
class CTCLabelDecode(BaseRecLabelDecode):
    ...
    def __init__(self,
                 ...
                 use_space_char=False,
                 **kwargs):
        super(CTCLabelDecode, self).__init__(character_type, use_space_char)
...
class AttnLabelDecode(BaseRecLabelDecode):
    ...
    def __init__(self,
                 ...
                 use_space_char=False,
                 **kwargs):
        super(AttnLabelDecode, self).__init__(character_type, use_space_char)
...
class SRNLabelDecode(BaseRecLabelDecode):
    ...
    def __init__(self,
        ...
        super(SRNLabelDecode, self).__init__(character_type, use_space_char)
