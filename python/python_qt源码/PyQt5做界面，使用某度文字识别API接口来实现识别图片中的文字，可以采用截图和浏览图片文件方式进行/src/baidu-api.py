...
class ScreenShot(QGraphicsView):
    ...
    def saveScreenshot(self, clipboard=False, fileName='../temp/temp.png', picType='png'):
    ...
    def saveOperation(self):
        filename = QFileDialog.getSaveFileName(self, 'Save file', '../temp/temp.png', '*.png;;*.jpg')
        if len(filename[0]) == 0:
            return
        else:
