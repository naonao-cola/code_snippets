...
if __name__ == "__main__":
    ...
    do_parse(input_path=r'E:\my_project\Multimodal_RAG\dots_ocr\2-8589.72.pdf', num_thread=32)
    # do_parse(input_path='./第二章 Apache Flink快速入门.pdf', num_thread=32, no_fitz_preprocess=True)
