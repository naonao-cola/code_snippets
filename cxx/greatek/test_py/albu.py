...
def get_augmentor(p=0.5):
    return A.Compose(
        [
            ...
            A.HueSaturationValue(hue_shift_limit=10, sat_shift_limit=10, val_shift_limit=10, p=p * 0.2),
            A.GaussianBlur(blur_limit=(3, 7), p=p * 0.1),
            A.GaussNoise(var_limit=(0, 0.05 * 255), p=p * 0.1),
...
if __name__ == "__main__":
    apply_aug(r"E:\demo\py\test01\ori", r"E:\demo\py\test01\ret", times=10)
