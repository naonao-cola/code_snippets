...
set_languages("c++17")
set_config("cuda", "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v11.8")
...
target("sam_test")
    ...
    add_files("$(projectdir)/src/main.cpp", "$(projectdir)/src/clip_bpe.cpp", "$(projectdir)/src/utils_2.cu")
