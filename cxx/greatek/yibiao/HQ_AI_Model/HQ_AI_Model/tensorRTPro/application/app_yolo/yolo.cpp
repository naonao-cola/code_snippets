...
struct AffineMatrix
{
    ...
    void compute(const cv::Size& from, const cv::Size& to)
    {
        ...
        **/
        ...
        /*
             + scale * 0.5 - 0.5
           的主要原因是使得中心更加对齐，下采样不明显，但是上采样时就比较明显
...
public:
    ...
    virtual void worker(promise<bool>& result) override
    {
        ...
        INFOE("engine file path: %s", file.c_str());
        ...
        int         num_classes    = (type_ == Type::V6 || type_ == Type::V8 || type_ == Type::V9 || type_ == Type::V10 || type_ == Type::V11 ||
                           type_ == Type::V12 || type_ == Type::V13)
                                         ? output->size(2) - 4
                                         : output->size(2) - 5;
