...
public:
    ...
    virtual bool startup(const string& file, int gpuid, bool use_multi_preprocess_stream)
    {
...
shared_ptr<Infer> create_infer(const string& engine_file, int gpuid, bool use_multi_preprocess_stream)
{
