...
public:
    ...
    {
        text_detector_ = DBDetector::create_detector(param.det_engine_file,
                                                     param.gpuid,
                                                     param.mask_thresh,
                                                     param.box_thresh,
                                                     param.unclip_ratio,
        ...
        if (param.use_angle_cls) {
            text_classifier_ = Classifier::create_classifier(
                param.cls_engine_file, param.gpuid, param.cls_thresh, param.cls_batch_num, param.use_multi_preprocess_stream);
        ...
        text_recognizer_ = SVTRRecognizer::create_recognizer(
            param.rec_engine_file, param.gpuid, param.dict_path, param.rec_batch_num, param.use_multi_preprocess_stream);
