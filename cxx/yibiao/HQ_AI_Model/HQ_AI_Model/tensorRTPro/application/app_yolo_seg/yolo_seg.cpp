                ...
                for (int i = 0; i < count; ++i) {
                    ...
                    if (keepflag == 1) {
                        ...
                        if (mask_out_width > 0 && mask_out_height > 0) {
                            ...
                            decode_single_mask(left * scale_to_predict_x,
                                               top * scale_to_predict_y,
                                               mask_weights,
                                               mask_head_predict,
                                               mask_head_output->size(3),
                                               mask_head_output->size(2),
                                               mask_out_device,
                                               mask_dim,
                                               mask_out_width,
                                               mask_out_height,
                            ...
                            checkCudaRuntime(
                                cudaMemcpyAsync(mask_out_host, mask_out_device, box_mask_output_memory.bytes(), cudaMemcpyDeviceToHost, stream_));
