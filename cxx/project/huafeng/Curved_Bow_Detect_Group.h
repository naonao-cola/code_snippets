...
class Curved_Bow_DetectAlgoGroup : public BaseAlgoGroup {
public:
    Curved_Bow_DetectAlgoGroup();
    virtual ~Curved_Bow_DetectAlgoGroup();

private:
    DCLEAR_ALGO_GROUP_REGISTER(Curved_Bow_DetectAlgoGroup)
};
