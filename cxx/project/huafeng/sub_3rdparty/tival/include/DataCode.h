...
namespace Tival
{
    ...
    public:
        ...
        */
         ...
         * - Num: 搜索个数 (N:搜到N个后停止搜索，def:1)
         * - Timeout: 搜索超时(ms)设置, 超过该时间则终止搜索（-1：无限等待，0~N: timeout时间，def: -1）
         * - ElemMin: 线条最小宽度（0.6~60）
         * - ElemMax: 线条最大宽度（1~256）
         * - HeightMin: 条码最小高度（8~512, def:-1）
         * - WidthMin: 条码最小宽度（20~2048，def:-1)
         * - CodeType：条码类型("Codabar", "Code 128", "Code 39", "Code 93", def:"auto")
        */
