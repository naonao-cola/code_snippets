...
ALWAYS_INLINE binn * binn_int64(int64_t value) {
...
ALWAYS_INLINE binn * binn_uint64(uint64_t value) {
...
int64_t          APIENTRY binn_list_int64(void *list, int pos);
...
uint64_t         APIENTRY binn_list_uint64(void *list, int pos);
...
int64_t          APIENTRY binn_map_int64(void *map, int id);
...
uint64_t         APIENTRY binn_map_uint64(void *map, int id);
...
int64_t          APIENTRY binn_object_int64(void *obj, const char *key);
...
uint64_t         APIENTRY binn_object_uint64(void *obj, const char *key);
...
ALWAYS_INLINE BOOL binn_list_add_int64(binn *list, int64_t value) {
...
ALWAYS_INLINE BOOL binn_list_add_uint64(binn *list, uint64_t value) {
...
ALWAYS_INLINE BOOL binn_map_set_int64(binn *map, int id, int64_t value) {
...
ALWAYS_INLINE BOOL binn_map_set_uint64(binn *map, int id, uint64_t value) {
...
ALWAYS_INLINE BOOL binn_object_set_int64(binn *obj, const char *key, int64_t value) {
...
ALWAYS_INLINE BOOL binn_object_set_uint64(binn *obj, const char *key, uint64_t value) {
...
ALWAYS_INLINE BOOL binn_list_get_int64(void *list, int pos, int64_t *pvalue) {
...
ALWAYS_INLINE BOOL binn_list_get_uint64(void *list, int pos, uint64_t *pvalue) {
...
ALWAYS_INLINE BOOL binn_map_get_int64(void *map, int id, int64_t *pvalue) {
...
ALWAYS_INLINE BOOL binn_map_get_uint64(void *map, int id, uint64_t *pvalue) {
...
ALWAYS_INLINE BOOL binn_object_get_int64(void *obj, const char *key, int64_t *pvalue) {
...
ALWAYS_INLINE BOOL binn_object_get_uint64(void *obj, const char *key, uint64_t *pvalue) {
...
BOOL   APIENTRY binn_get_int64(binn *value, int64_t *pint);
