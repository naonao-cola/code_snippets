...
inline int64_t _volume(const nvinfer1::Dims& d)
{
...
public:
    ...
    {
        return this->resize(_volume(dims));
    }
...
//!
//! \brief  The TrtBufferManager class handles host and device buffer allocation and deallocation.
//!
//! \details This RAII class handles host and device buffer allocation and deallocation,
//!          memcpy between host and device buffers to aid with inference,
//!          and debugging dumps to validate inference. The TrtBufferManager class is meant to be
//!          used to simplify buffer management and any interactions between buffers and the engine.
//!
class TrtBufferManager
{
public:
    static const size_t kINVALID_SIZE_VALUE = ~size_t(0);

    //!
    //! \brief Create a TrtBufferManager for handling buffer interactions with engine.
    //!
    TrtBufferManager(std::shared_ptr<nvinfer1::ICudaEngine> engine, const int batchSize = 0,
