...
private:
    ...
    double window_h_ = 400;
    double window_w_ = 400;
    ...
    void             crop_img(cv::Mat img,cv::Rect img_rect,std::vector<cv::Rect>& windows_rect, std::vector<cv::Mat>&windows_img);
    
    std::vector<cv::Point2f> cal_img(cv::Mat org_img,cv::Rect img_rect, std::vector<cv::Rect> windows_rect, std::vector<cv::Mat> windows_img);
