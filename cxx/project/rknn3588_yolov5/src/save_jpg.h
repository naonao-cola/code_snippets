/**
 * @FilePath     : /test03/src/save_jpg.h
 * @Description  :
 * @Author       : naonao
 * @Date         : 2025-07-24 17:43:10
 * @Version      : 0.0.1
 * @LastEditors  : naonao
 * @LastEditTime : 2025-07-25 16:49:58
...
int jo_write_jpg(const char* filename, const void* data, int width, int height, int comp, int quality)
{
    ...
    quality_factor = quality_factor < 1 ? 1 : quality_factor > 100 ? 100
                                                                   : quality_factor;
    ...
    for (int i = 0; i < 64; ++i) {
        ...
        YTable[s_jo_ZigZag[i]] = yti < 1 ? 1 : yti > 255 ? 255
                                                         : yti;
        int uvti = (UVQT[i] * quality_factor + 50) / 100;
        UVTable[s_jo_ZigZag[i]] = uvti < 1 ? 1 : uvti > 255 ? 255
                                                            : uvti;
    }
