...
#define NE_KEY_PERCENTAGE "NEUT%"
#define LY_KEY_PERCENTAGE "LYMPH%"
#define MO_KEY_PERCENTAGE "MONO%"
#define EO_KEY_PERCENTAGE "EO%"
#define BA_KEY_PERCENTAGE "BASO%"

#define NE_KEY_NUM "NEUT#"
#define LY_KEY_NUM "LYMPH#"
#define MO_KEY_NUM "MONO#"
#define EO_KEY_NUM "EO#"
#define BA_KEY_NUM "BASO#"
...
#define NRBC_KEY_PERCENTAGE "NRBC%"
...
typedef struct HeamoCnt
{
    ...
    // 疟原虫单个计数
    std::vector<int> heamo_pla_nums_v;
    std::vector<int> heamo_pv1_nums_v;
    std::vector<int> heamo_pv2_nums_v;
    std::vector<int> heamo_pv3_nums_v;
    std::vector<int> heamo_pv4_nums_v;
    std::vector<int> heamo_pv5_nums_v;
    std::vector<int> heamo_pv6_nums_v;

    //荧光微球
    int MIC_FLU=0;
    std::vector<int> heamo_mic_flu_v;
    std::vector<int> heamo_mic_flu_x;
    std::vector<int> heamo_mic_flu_y;
    std::vector<int> heamo_mic_flu_z;
...
int          Heamo_AddImgList(HeamoCtxID_t           ctx_id,
                              ...
                              uint32_t               height);
int          Heamo_PushImage(
             HeamoCtxID_t ctx_id, std::list<HeamoImg_t>& img_list, uint32_t group_idx, uint32_t chl_idx, const int& view_pair_idx, int checkout_flag,int x,int y,int z);
