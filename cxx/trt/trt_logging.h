...
{
public:
    explicit TrtLoggerImpl(Severity severity = Severity::kWARNING)
    ...
    //!
    //! \brief Forward-compatible method for retrieving the nvinfer::ILogger associated with this TrtLoggerImpl
    //! \return The nvinfer1::ILogger associated with this TrtLoggerImpl
    //!
    //! TODO Once all samples are updated to use this method to register the logger with TensorRT,
    //! we can eliminate the inheritance of TrtLoggerImpl from ILogger
    //!
    ...
    //!
    //! This object is an opaque handle to information used by the TrtLoggerImpl to print test results.
    //! The sample must call TrtLoggerImpl::defineTest() in order to obtain a TestAtom that can be used
    //! with TrtLoggerImpl::reportTest{Start,End}().
    //!
    class TestAtom
    {
    public:
    ...
    //
    //! \return a TestAtom that can be used in TrtLoggerImpl::reportTest{Start,End}().
    //!
